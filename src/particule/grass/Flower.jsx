...
export const Flower = forwardRef((props, ref) => {
  const { nodes } = useGLTF('/load/objects/flower.glb')
  const map = useTexture('/load/Sea_Thrift_vkbgaihha/Albedo_2K__vkbgaihha.jpg')
  const ao = useTexture('/load/Sea_Thrift_vkbgaihha/AO_2K__vkbgaihha.jpg')
