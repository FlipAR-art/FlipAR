...
import MountainMaterial from "./MountainMaterial.jsx";
...
const Terrain = ({ seed, size, height, levels = 8, scale = 1, offset }) => {
  ...
  const sides = useMemo(
    () => ({
      north: new Float32Array(size * 60),
      east: new Float32Array(size * 60),
      south: new Float32Array(size * 60),
      west: new Float32Array(size * 60),
    }),
    [size]
  );
